<?php 
	...
	if(isset($_POST['login']) && $_POST['login'] == 'ok') {
		...
		if($acc == "") {
			...
			$mailAcc = "<li>Je souhaites partager ma chambre avec : ".$acc."</li>";
		}
		...
		if($email != '') {
			...
			$mail->Subject = 'Inscription "Consulting & Strategy End"';
			...
			<li>Grade / Fonction : '.$fonction.'</li>
			<li>BU : '.$bu.'</li>
			<li>Serez-vous présent ? : '.$participationnom.'</li>
			<li>Participation aux activités : '.$participationTeam.'</li>
			<li>Participation au diner : '.$participationDiner.'</li>
